...
function firstQuestion(){
    ...
    $('.content').hide();
    Swal.fire({
        title: 'Hi các vợ iu của Thế Anh',
...
function textGenerate() {
    var n = "";
    var text = " Tại vì Thế Anh đẹp trai vl 3333 ";
